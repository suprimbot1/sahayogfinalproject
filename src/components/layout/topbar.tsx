...
export function Topbar() {
  ...
  return (
    <header className="h-16 border-b border-border bg-background flex items-center justify-end px-8 fixed top-0 right-0 left-64 z-50 w-[calc(100%-16rem)]">
      <div className="flex items-center gap-6">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          <div
            ...
            className="flex items-center gap-3 cursor-pointer hover:bg-muted p-1.5 rounded-xl transition-all select-none"
          >
        ...
        {/* Dropdown Menu */}
        {isOpen && (
          <div className="absolute right-0 mt-3 w-72 bg-card rounded-3xl shadow-2xl border border-border py-3 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="px-5 py-4 flex items-center gap-4 border-b border-border mb-2">
              ...
              <div className="flex flex-col">
                <span className="text-[15px] font-black text-foreground leading-tight">{user.name}</span>
            ...
            <div className="px-2 space-y-1">
              ...
              <Link
                ...
                className="flex items-center gap-4 px-4 py-3 text-[15px] font-bold text-foreground hover:bg-muted rounded-2xl transition-colors group"
              >
                <div className="w-9 h-9 bg-muted rounded-xl flex items-center justify-center group-hover:bg-background border border-transparent group-hover:border-border transition-all">
